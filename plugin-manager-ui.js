class PluginManagerUIPlugin extends Plugin {
  ...
  createPanelContent() {
    ...
    try {
      ...
      container.appendChild(this.createNotificationTestSection());
  ...
  createNotificationTestSection() {
    ...
    title.style.cssText = "margin: 0; color: #e0e0e0; font-size: 15px;";
    title.innerHTML =
      '<i class="ri-notification-3-line" style="margin-right: 8px;"></i>Test Notifications';

    const toggleIcon = document.createElement("i");
    toggleIcon.className = "ri-arrow-down-s-line";
    toggleIcon.style.cssText = "color: #909090; font-size: 20px;";
    ...
    this.registerListener(header, "click", () => {
    ...
    inputLabel.style.cssText =
      "display: block; color: #b0b0b0; margin-bottom: 6px; font-size: 12px;";
    inputLabel.textContent = "Test Message:";

    const messageInput = document.createElement("input");
    messageInput.type = "text";
    messageInput.className = "el-input__inner";
    messageInput.value = "Test notification from Plugin Manager";
    messageInput.placeholder = "Enter test message...";
    ...
    const notificationMethods = [
      {
        ...
        action: () => {
          if (typeof Noty !== "undefined") {
            new Noty({ type: "success", text: messageInput.value }).show();
          }
        },
      },
      {
        ...
        action: () => {
          if (typeof Noty !== "undefined") {
            new Noty({ type: "info", text: messageInput.value }).show();
          }
        },
      },
      {
        ...
        action: () => {
          if (typeof Noty !== "undefined") {
            new Noty({ type: "warning", text: messageInput.value }).show();
          }
        },
      },
      {
        ...
        action: () => {
          if (typeof Noty !== "undefined") {
            new Noty({ type: "error", text: messageInput.value }).show();
          }
        },
      },
      {
      ...
      },
      {
        ...
        action: () => {
          window.$pinia?.notification?.playNoty({
            ...
            displayName: messageInput.value || "Test User",
      ...
      },
      {
        ...
        action: () => {
          window.$pinia?.notification?.playNoty({
            ...
            worldName: messageInput.value || "Test World",
            time: 0,
            isFriend: true,
            isFavorite: false,
          });
    ...
    notificationMethods.forEach((method) => {
      ...
      `;
      btn.innerHTML = `<i class="${method.icon}"></i>${method.label}`;

      this.registerListener(btn, "click", () => {
        try {
          method.action();
          ...
          this.logger.error(`Failed to trigger ${method.label}:`, error);
        }
      });

      this.registerListener(btn, "mouseenter", () => {
        btn.style.opacity = "0.8";
      });

      this.registerListener(btn, "mouseleave", () => {
        btn.style.opacity = "1";
      });
